...
let protect_privacy_messenger_parent_selectors = {
  left_sidebar: 'div[class~=j83agx80][class~=cbu4d94t][class~=buofh1pr][class~=l9j0dhe7]',
...
let protect_privacy_messenger_data = {
  ...
  image: {
    selector: [
      ...
      protect_privacy_messenger_parent_selectors.left_sidebar + ' img[class~=a8c37x1j][class~=d2edcug0][class~=sn7ne77z][class~=bixrwtb6]', // avatar in left sidebar
      protect_privacy_messenger_parent_selectors.left_sidebar +
  ...
  message: {
    selector: [
      ...
      protect_privacy_messenger_parent_selectors.main +
      ' span[class~=a8c37x1j][class~=hihg3u9x][class~=ggxiycxj][class~=l9j0dhe7][class~=d2edcug0][class~=hpfvmrgz][class~=qv66sw1b][class~=c1et5uql][class~=fe6kdd0r][class~=mau55g9w][class~=c8b282yb][class~=keod5gw0][class~=nxhoafnm][class~=aigsh9s9][class~=lr9zc1uh][class~=e9vueds3][class~=knj5qynh][class~=m9osqain][class~=hzawbc8m][class~=d9wwppkn][class~=mdeji52x][class~=l3itjdph]', // quote message in chatbox
      protect_privacy_messenger_parent_selectors.main +

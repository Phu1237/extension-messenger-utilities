...
let protect_privacy_messenger_data = {
  ...
  name: {
    ...
    selector: [
      ...
      protect_privacy_messenger_parent_selectors.main + ' div[class~=x12scifz][class~=x1pg5gke][class~=x1h0ha7o]', // quote name in group chat
      protect_privacy_messenger_parent_selectors.main + ' span[class~=x193iq5w][class~=xeuugli][class~=x13faqbe][class~=x1vvkbs][class~=xt0psk2][class~=x1xmvt09][class~=x1nxh6w3][class~=x1s688f][class~=xzsf02u][class~=xq9mrsl]', // quote name in chatbot
  ...
  message: {
    selector: [
      ...
      protect_privacy_messenger_parent_selectors.main + ' div[class~=x1tlxs6b][class~=x1g8br2z][class~=x1gn5b1j][class~=x14ctfv][class~=x1okitfd][class~=x6ikm8r][class~=x10wlt62][class~=x1mzt3pk][class~=x1y1aw1k][class~=xn6708d][class~=xwib8y2][class~=x1ye3gou][class~=x1n2onr6][class~=x13faqbe][class~=x1vjfegm][class~=x10y3i5r]', // quoted message

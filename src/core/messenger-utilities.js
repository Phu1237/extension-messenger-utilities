...
let protect_privacy_messenger_parent_selectors = {
  ...
  left_sidebar:
    'div[class~=x78zum5][class~=xdt5ytf][class~=x1iyjqo2][class~=xs83m0k][class~=x1xzczws][class~=x6ikm8r][class~=x1rife3k][class~=x1n2onr6][class~=xh8yej3]',
  ...
  right_sidebar:
    'div[class~=x9f619][class~=x1n2onr6][class~=x1ja2u2z][class~=x78zum5][class~=xdt5ytf][class~=x1yu6fn4][class~=xs83m0k][class~=x1dt7z5j][class~=x2ixbly][class~=x4xrfw5]',
}
let protect_privacy_messenger_main_selectors = {
  name: [
    protect_privacy_messenger_parent_selectors.main +
      ' h1 span>span[class~=x1lliihq][class~=x193iq5w][class~=x6ikm8r][class~=xlyipyv][class~=xuxw1ft][class~=x1j85h84]', // main chat name & online status
    protect_privacy_messenger_parent_selectors.main +
  ...
  image: [
    protect_privacy_messenger_parent_selectors.main +
      ' img[class~=x1lliihq][class~=x193iq5w][class~=x1us19tq][class~=xl1xv1r]', // avatar in main chat
    ...
    protect_privacy_messenger_parent_selectors.main +
      ' img[class~=xxymvpz][class~=x6jxa94][class~=x1v9usgg][class~=x14yjl9h][class~=xudhj91][class~=x18nykt9][class~=xww2gxu][class~=x1m6msm][class~=x19um543]', // seen avatar icon in group
    protect_privacy_messenger_parent_selectors.main +
      ' div[class~=mfclru0v][class~=h4m39qi9][class~=pytsy3co]', // video
    protect_privacy_messenger_parent_selectors.main +
      ' img[class~=xh8yej3][class~=xl1xv1r][class~=x5yr21d][class~=x1rg5ohu]', // chatter avatar
    protect_privacy_messenger_parent_selectors.main +
    ...
    protect_privacy_messenger_parent_selectors.main +
      ' img[class~=x1lliihq][class~=x193iq5w][class~=x5yr21d][class~=xh8yej3]', // message img
    protect_privacy_messenger_parent_selectors.main +
      ' div[class~=x193iq5w][class~=x1n2onr6][class~=x1vjfegm] div[role=img]', // sticker img
  ...
  message: [
    ...
    protect_privacy_messenger_parent_selectors.main +
      ' span[class~=x1lliihq][class~=x193iq5w][class~=x6ikm8r][class~=x10wlt62]', // link title
    protect_privacy_messenger_parent_selectors.main +
      ' div[class~=cgu29s5g][class~=alzwoclg][class~=jl2a5g8c][class~=b7mnygb8][class~=nch0832m][class~=oxkhqvkx]', // link title (group link)
  ],
  chatbox: [
...
let protect_privacy_messenger_right_sidebar_selectors = {
  ...
  image: [
    protect_privacy_messenger_parent_selectors.right_sidebar +
      ' svg[class=x3ajldb] g', // right avatar
  ],
}
...
let protect_privacy_messenger_data = {
  ...
  name: {
    ...
    selector: [
      protect_privacy_messenger_parent_selectors.left_sidebar +
        ' span[class~=x1lliihq][class~=x193iq5w][class~=x6ikm8r][class~=xlyipyv][class~=xuxw1ft]', // left sidebar name ([class~=x1j85h84] for seen)
    ],
  },
  image: {
    name: 'image',
    selector: [
      protect_privacy_messenger_parent_selectors.left_sidebar +
        ' img[class~=x1lliihq][class~=x193iq5w][class~=x1us19tq][class~=xl1xv1r]', // avatar in left sidebar
      protect_privacy_messenger_parent_selectors.left_sidebar +
  ...
  message: {
    ...
    selector: [
      protect_privacy_messenger_parent_selectors.left_sidebar +
        ' span[class~=x1lliihq][class~=x6ikm8r][class~=x10wlt62][class~=x1n2onr6][class~=xlyipyv][class~=xuxw1ft][class~=x1j85h84]', // left sidebar message
    ],
  },
}

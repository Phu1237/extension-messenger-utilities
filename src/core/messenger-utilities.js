...
let protect_privacy_messenger_parent_selectors = {
  left_sidebar: 'div[class~=alzwoclg][class~=cqf1kptm][class~=cgu29s5g][class~=lq84ybu9][class~=hf30pyar][role=grid]',
  main: 'div[class~=bdao358l][class~=g4tp4svg][class~=gvxzyvdx][class~=aeinzg81][class~=jg3vgc78][class~=cgu29s5g][class~=i15ihif8][class~=alzwoclg][class~=cqf1kptm][class~=om3e55n1][class~=lq84ybu9][class~=hf30pyar]',
  right_sidebar: 'div[class~=bdao358l][class~=om3e55n1][class~=g4tp4svg][class~=alzwoclg][class~=cqf1kptm][class~=aif6hojh][class~=i15ihif8][class~=epuzgip0][class~=c4xbxh63][class~=jnmqv028]',
}
let protect_privacy_messenger_data = {
  ...
  name: {
    name: 'name',
    selector: [
      protect_privacy_messenger_parent_selectors.left_sidebar + ' span[class~=b6ax4al1][class~=i54nktwv][class~=z2vv26z9][class~=om3e55n1][class~=gvxzyvdx][class~=aeinzg81][class~=t7p7dqev][class~=gh25dzvf][class~=gem102v4][class~=ncib64c9][class~=mrvwc6qr][class~=sx8pxkcf][class~=f597kf1v][class~=cpcgwwas][class~=exr7barw][class~=k1z55t6l]', // left sidebar name ([class~=tpi2lg9u][class~=hxfwr5lz] for seen) ([class~=o48pnaf2][class~=ib8x7mpr] for unseen)
      protect_privacy_messenger_parent_selectors.main + ' h1 span>span[class~=b6ax4al1][class~=gvxzyvdx][class~=lq84ybu9][class~=oshhggmv][class~=qm54mken][class~=tr46kb4q]', // main chat name & online status
      protect_privacy_messenger_parent_selectors.main + ' div[data-testid=mw_message_sender_name]', // name in group chat
      protect_privacy_messenger_parent_selectors.main + ' div[class~=f1iqohp5][class~=jlyy7hdl][class~=glosn74e]', // quote name
      protect_privacy_messenger_parent_selectors.right_sidebar + ' div[class~=jroqu855][class~=nthtkgg5] a', // right sidebar name
    ],
  },
  image: {
    selector: [
      protect_privacy_messenger_parent_selectors.left_sidebar + ' img[class~=b6ax4al1][class~=gvxzyvdx][class~=dgxim35p][class~=p9wrh9lq]', // avatar in left sidebar
      ...
      protect_privacy_messenger_parent_selectors.main + ' img[class~=b6ax4al1][class~=gvxzyvdx][class~=dgxim35p][class~=p9wrh9lq]', // avatar in main chat
      ...
      protect_privacy_messenger_parent_selectors.main + ' img[class~=bq6c9xl4][class~=obt709sw][class~=cl67t5wl][class~=qmqpeqxj][class~=e7u6y3za][class~=qwcclf47][class~=nmlomj2f][class~=h4fuj9y9][class~=e7m00etv]', // seen avatar icon in group
      protect_privacy_messenger_parent_selectors.main + ' div[class~=mfclru0v][class~=h4m39qi9][class~=pytsy3co]', // video
      protect_privacy_messenger_parent_selectors.main + ' img[class~=mfclru0v][class~=p9wrh9lq][class~=pytsy3co][class~=aglvbi8b]', // chatter avatar
      /* FIX: need fix */
      ...
      protect_privacy_messenger_parent_selectors.main + ' img[class~=b6ax4al1][class~=gvxzyvdx][class~=pytsy3co][class~=mfclru0v]', // message img
      protect_privacy_messenger_parent_selectors.main + ' div[class~=alzwoclg][class~=cqf1kptm][class~=gvxzyvdx][class~=om3e55n1][class~=gldv74r8] > span > div > div > div[role=img]', // sticker img
      protect_privacy_messenger_parent_selectors.main + ' div[class~=mfclru0v][class~=alzwoclg][class~=om3e55n1] > img', // link img
      protect_privacy_messenger_parent_selectors.right_sidebar + ' div[class~=aglvbi8b][class~=om3e55n1][class~=i8zpp7h3][class~=g4tp4svg]', // right avatar
  ...
  message: {
    selector: [
      protect_privacy_messenger_parent_selectors.left_sidebar + ' span[class~=gvxzyvdx][class~=aeinzg81][class~=t7p7dqev][class~=gh25dzvf][class~=exr7barw][class~=b6ax4al1][class~=gem102v4][class~=ncib64c9][class~=mrvwc6qr][class~=sx8pxkcf][class~=f597kf1v][class~=cpcgwwas][class~=f5mw3jnl][class~=hxfwr5lz][class~=nfkogyam][class~=kkmhubc1][class~=tes86rjd][class~=rtxb060y]', // left sidebar message
      ...
      protect_privacy_messenger_parent_selectors.main + ' div[class~=cgu29s5g][class~=alzwoclg][class~=jl2a5g8c][class~=b7mnygb8]', // link title

  ...
  <div class="p-1">
    ...
    <div class="px-2">
      ...
      <div class="px-1">
        <input
          type="checkbox"
          :checked="form.protect_domains['messenger.com']"
          @click="
            form.protect_domains['messenger.com'] =
              !form.protect_domains['messenger.com']
          "
        />
        messenger.com
      ...
      <div class="px-1">
        <input
          type="checkbox"
          :checked="form.protect_domains['facebook.com']"
          @click="
            form.protect_domains['facebook.com'] =
              !form.protect_domains['facebook.com']
          "
        />
        facebook.com
    ...
    <div class="px-2">
      ...
      >
        <li class="filter-switch-item flex relative h-8 bg-gray-300">
          <input
            id="protect_title_disable"
            name="protect_title"
            type="radio"
            class="sr-only"
            value="disable"
            :checked="!form.protect_title"
            @change="form.protect_title = false"
          />
          <label
            for="protect_title_disable"
            class="h-8 py-1 px-2 bg-white text-sm leading-6 text-gray-600 hover:text-blue-600 rounded shadow"
          >
            Disable
          </label>
        ...
        <li class="filter-switch-item flex relative h-8 bg-gray-300x">
          <input
            id="protect_title_enable"
            name="protect_title"
            type="radio"
            class="sr-only"
            value="enable"
            :checked="form.protect_title"
            @change="form.protect_title = true"
          />
          <label
            for="protect_title_enable"
            class="h-8 py-1 px-2 bg-white text-sm leading-6 text-gray-600 hover:text-blue-600 rounded shadow"
          >
            Enable
          </label>
...
export default defineComponent({
  ...
  created() {
    ...
    this.alert = {
      message: this._localStorage.notification.message,
    }
  },
  methods: {
